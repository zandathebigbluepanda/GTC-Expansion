...
public class GTCXRecipeMods {
    public static void init(){
        ...
        if (Loader.isModLoaded("appliedenergistics2")){
            ClassicRecipes.electrolyzer.addChargeRecipe(GTMaterialGen.getModMetaItem("appliedenergistics2", "material", 0, 1), GTMaterialGen.getModMetaItem("appliedenergistics2", "material", 1, 1), 800, GTMaterialGen.getModMetaItem("appliedenergistics2", "material", 1, 1).getTranslationKey());
